...
export default async function Home() {
 ...
 const lands =  JSON.parse(file);
  return (
    <main className="flex min-h-screen w-[99%] flex-col items-center justify-center  gap-y-20 px-10 text-black">
      {lands.map((land)=>{
        return <div className="w-full rounded-sm flex-col bg-white pt-2 gap-10">
